#include<windows.h> // this is very important otherwise not run this project show error
#ifdef _WIN32
	#include<windows.h>
#endif
#include<stdio.h>
...
void introScreen()
{
	glClear(GL_COLOR_BUFFER_BIT);
		...
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-625, 490, 0.0,"JASHORE UNIVERSITY OF SCIENCE AND TECHNOLOGY");
	...
	//displayRasterText(-100, 150, 0.0,"created by");
		//glColor3f(1.0, 1.0, 1.0);
	 //displayRasterText(-130, 80, 0.0,"JAKARIA");
	 	glColor3f(1.0, 0.0, 0.0);
	  displayRasterText(-800, -100, 0.0," STUDENT NAME");
	  	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-800, -200, 0.0,"Md. Jakaria Ibna Azam Khan");

		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(500, -100, 0.0,"Under the Guidance of");
		glColor3f(1.0, 1.0, 1.0);
	displayRasterText(500, -200, 0.0,"Mostafijur Rahman Akhond");
	displayRasterText(500,-300,0.0,"Assistant Professor ");
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-250, -400, 0.0,"Academic Year 2019-2020");
        glColor3f(1.0, 1.0, 1.0);
